...
/**
 * HOL 4: Country CRUD using REST URL naming conventions.
 *   GET    /countries          → getAllCountries
 *   GET    /countries/{code}   → getCountry
 *   POST   /countries          → addCountry (uses @Valid)
 *   PUT    /countries          → updateCountry (uses @Valid)
 *   DELETE /countries/{code}   → deleteCountry
 */
@RestController
